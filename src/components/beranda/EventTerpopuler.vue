...
<div class="container mb-5">
    <div class="row justify-content-between">
      ...
      <div class="col text-right">
        <p><a href="#" style="text-decoration: none;">lihat semua</a></p>
      </div>
    </div>
    <div class="row">
      <div class="container-fluid">
        <div id="carousel-event-terpopuler" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-item col-md-3 active">
              <div class="card h-100">
                ...
                <div class="card-body" style="position: relative;">
                  ...
                  <a href="./event.html" target="_blank" style="text-decoration: none;">
          ...
          <a class="carousel-control-prev" href="#carousel-event-terpopuler" role="button" data-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="sr-only">Previous</span>
          </a>
          <a class="carousel-control-next" href="#carousel-event-terpopuler" role="button" data-slide="next">
